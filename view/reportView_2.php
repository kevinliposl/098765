        ...
        <div class="container clearfix">
            <div class="col_full">
                <select id="form-report" class="selectpicker form-control" data-live-search="true">
                    ...
                    <option value="matriculadosporMes" data-tokens>Matriculados por Mes</option>
...
<script>
    $("#form-report").change(function () {
        ...
        } else if (option === "matriculadosporMes") {
            $.post("?controller=Report&action=selectEnrolledPerMonth", {}, function (data) {
