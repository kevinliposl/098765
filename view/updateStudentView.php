                        ...
                        <div class="acc_content clearfix">
                            <form id="form" class="nobottommargin">
                                <div class="white-section">
                                    ...
                                    <input type="hidden" id="warning" data-notify-type="warning" data-notify-msg="<i class='icon-warning-sign'></i> El Estudiante no se pudo actualizar!" data-notify-position="bottom-full-width"/>
                            ...
                            <table class="table table-bordered table-striped" style="clear: both">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>G&eacute;nero</td>
                                        <td>
                                            <a id="form-gender" href="#" class="bt-group" data-type="select" data-pk="1" data-value="" data-title="Select sex"></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Nacionalidad</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a id="form-age" href="#" class="bt-editable" data-type="combodate" data-format="YYYY-MM-DD" data-viewformat="YYYY-MM-DD" data-template="YYYY / MMM / D" data-pk="1"  data-title="Ingrese la fecha de nacimiento"></a>
                                        </td>
                                    </tr>
                                    <tr>
