    ...
    <div class="slider-parallax-inner">
        ...
        <div class="swiper-container swiper-parent">
            <div class="swiper-wrapper">
                <div class="swiper-slide dark" style="background-image: url('public/images/slider/swiper/1.jpg');">
                ...
                <div class="swiper-slide dark">
                    ...
                    <div class="video-wrap">
                        <video id="slide-video" poster="public/images/videos/explore.jpg" preload="auto" loop autoplay muted>
                            <source src='public/images/videos/explore.webm' type='video/webm' />
                            <source src='public/images/videos/explore.mp4' type='video/mp4' />
                        </video>
                        <div class="video-overlay" style="background-color: rgba(0,0,0,0.55);"></div>
                    </div>
                </div>
                <div class="swiper-slide" style="background-image: url('public/images/slider/swiper/3.jpg'); background-position: center top;">
                    <div class="container clearfix">
    ...
    <div class="content-wrap">
        ...
        <div class="container clearfix">
            ...
            <div class="row topmargin-lg bottommargin-sm">
                ...
                <div class="col-md-4 hidden-sm bottommargin center">
                    <img src="public/images/services/iphone7.png" alt="iphone 2">
                </div>
                ...
                <div>
                    ...
                    <div class="center bottommargin">
                        <a href="http://vimeo.com/101373765" data-lightbox="iframe" style="position: relative;">
                            <img src="public/images/services/video.jpg" alt="Video">
                            <span class="i-overlay nobg"><img src="public/images/icons/video-play.png" alt="Play"></span>
                        </a>
                    </div>
        ...
        <div id="portfolio" class="portfolio portfolio-nomargin grid-container portfolio-notitle portfolio-full grid-container clearfix">
            ...
            <article class="portfolio-item pf-media pf-icons">
                <div class="portfolio-image">
                    <a href="portfolio-single.html">
                        <img src="public/images/portfolio/4/1.jpg" alt="Open Imagination">
                    </a>
                ...
                <div class="portfolio-desc">
                    <h3><a href="public/portfolio-single.html">Open Imagination</a></h3>
            ...
            <article class="portfolio-item pf-illustrations">
                <div class="portfolio-image">
                    <a href="portfolio-single.html">
                        <img src="public/images/portfolio/4/2.jpg" alt="Locked Steel Gate">
                    </a>
                    <div class="portfolio-overlay">
            ...
            <article class="portfolio-item pf-graphics pf-uielements">
                <div class="portfolio-image">
                    <a href="#">
                        <img src="public/images/portfolio/4/3.jpg" alt="Mac Sunglasses">
                    </a>
                    <div class="portfolio-overlay">
            ...
            <article class="portfolio-item pf-icons pf-illustrations">
                <div class="portfolio-image">
                    <a href="portfolio-single.html">
                        <img src="public/images/portfolio/4/4.jpg" alt="Open Imagination">
                    </a>
            ...
            <article class="portfolio-item pf-uielements pf-media">
                <div class="portfolio-image">
                    <a href="portfolio-single.html">
                        <img src="public/images/portfolio/4/5.jpg" alt="Console Activity">
                    </a>
                    <div class="portfolio-overlay">
                        <a href="public/images/portfolio/full/5.jpg" class="left-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
            ...
            <article class="portfolio-item pf-graphics pf-illustrations">
                <div class="portfolio-image">
                    <a href="portfolio-single.html">
                        <img src="public/images/portfolio/4/6.jpg" alt="Open Imagination">
                    </a>
                    <div class="portfolio-overlay" data-lightbox="gallery">
                        <a href="public/images/portfolio/full/6.jpg" class="left-icon" data-lightbox="gallery-item"><i class="icon-line-stack-2"></i></a>
                        <a href="public/images/portfolio/full/6-1.jpg" class="hidden" data-lightbox="gallery-item"></a>
                        <a href="public/images/portfolio/full/6-2.jpg" class="hidden" data-lightbox="gallery-item"></a>
                        <a href="public/images/portfolio/full/6-3.jpg" class="hidden" data-lightbox="gallery-item"></a>
                        <a href="portfolio-single-gallery.html" class="right-icon"><i class="icon-line-ellipsis"></i></a>
                    </div>
                </div>
                <div class="portfolio-desc">
            ...
            <article class="portfolio-item pf-uielements pf-icons">
                <div class="portfolio-image">
                    <a href="portfolio-single-video.html">
                        <img src="public/images/portfolio/4/7.jpg" alt="Backpack Contents">
                    </a>
                    <div class="portfolio-overlay">
